@props(['value'=> ''])
<div class="relative">
    <div class="bg-custom-green-500 rounded-2xl  desktop:h-[255px] h-[193px]  opacity-[0.08]">
    </div>
    <div class="absolute top-0   h-[193px]  desktop:h-[255px] flex flex-col items-center ml-[50%] -translate-x-1/2">
