<div class="grid grid-cols-4 grid-row-1  h-14 items-center desktop:max-w-[770px] max-w-[375px] ">
    <div>
        <a href="{{route('sort', ['locale' => app()->getLocale(), 'search' => request('search'), 'sort' => 'country', 'by' => request('by') == 'desc' ? 'asc' : 'desc'])}}" class="flex items-center">
    ...
    <div >
        <a href="{{route('sort', ['locale' => app()->getLocale(), 'search' => request('search'), 'sort' => 'new_cases', 'by' => request('by') == 'desc' ? 'asc' : 'desc'])}}" class="flex items-center">
    ...
    <div >
        <a href="{{route('sort', ['locale' => app()->getLocale(), 'search' => request('search'), 'sort' => 'deaths', 'by' => request('by') == 'desc' ? 'asc' : 'desc'])}}" class="flex items-center">
    ...
    <div >
        <a href="{{route('sort', ['locale' => app()->getLocale(), 'search' => request('search'), 'sort' => 'recovered', 'by' => request('by') == 'desc' ? 'asc' : 'desc'])}}" class="flex items-center">
