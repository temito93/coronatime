...
<section class="desktop:pb-14 pb-0  desktop:px-[108px]">
    <form class="desktop:w-[239px] max-w-[375px]  desktop:mt-10 mt-0" method="GET" action="{{route('search')}}">
        ...
        <div class="relative">
            ...
            <input type="text" name="search" class="block w-full desktop:py-4 py-[25px] pl-[60px] text-sm text-custom-black border-none  desktop:border-solid  desktop:border-custom-neutral-200 rounded-lg  focus:ring-blue-500 focus:border-blue-500 placeholder-custom-zinc" placeholder="Search by country">
        </div>
    </form>
